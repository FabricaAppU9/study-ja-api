...
Usuarios.prototype.getUserInfo = function (id, callback) {
    this._connection.query("select usu_id, usu_nome, usu_sobrenome, usu_sexo, usu_dat_nascimento,usu_email,usu_cpf,usu_img_perfil from usuario where usu_id=?", id, callback);
}
